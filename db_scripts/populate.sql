...
insert into card (crd_name, crd_atk, crd_def,  crd_abl, crd_desc) values 
   ...
   ("DrFamiliar",500,500,"Removes the ability from the card in front.","He used to be a doctor, now he is the great wizard and belongs to a group of super individuals."),
   ("SusBob",300,300,"The opponent can't take a card in the next turn.","He looks like one of us but he acts kinda sus. Likes to sabotage others."),
   ...
   ("GameDev",500,500,"Uses a cheat code giving double attack to all allied cards on the field.","In the real world he is known as a geek but online he is a superhero."),
   ("BobRocky",600,500,"With his punches breaks the enemy shield giving all the damage to the player.","One of the best boxers in the universe, he is not afraid of anyone. His record is 175-0-0, 110 by KO."),
   ("Reaper",600,200,"Take a card of your choice from the graveyard.","He is also known as the death, but he is a nice guy."),
   ("Bobnaldo",400,200,"The enemy card fouls the football player and can't play for a turn.","He is also known as the magician, because when he has a football on his foot he can do whatever he wants."),
   ("SuperBob",600,500,"With his teleportation ability he changes his spot with another ally card.","He belongs to a race of conquerors from planet Vegeta, but he has a good heart. He has a monkey tail and sometimes his hair turns blonde and gets super strong but we don't know why."),
   ("Pirate",600,500,"It steals a card of your choice from the enemy's deck by stretching his arm.","A young and optimistic pirate that ate one of the devil fruits and now his body is like rubber."),
   ("Bomber",0,0,"He creates a massive explosion and both cards are destroyed .","He has always been seen as a danger but is willing to put down his life to help others. He is the real hero."),
   ("Stickman",200,600,"He throws a lot of sticks at the opponent and gives him a concussion taking 150 shield from the card and 150 HP from the player.","He is literally a stickman made from wooden sticks."),
   ("Hitman",600,300,"He insta kills the opponent card in front.","He is a stickman that is a hitman. When he gets a specific target he always gets the job done.");
